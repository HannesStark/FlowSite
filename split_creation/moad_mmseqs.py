...
moad_path = 'data/moad/moad_prepared'
unit_names = os.listdir(moad_path)


PROTEIN_SEQS = 'data/all_moad_sequences_nonJupyter.fasta'
OUT_DIR = "data/"
OUT_PATH = "data/"
SEQ_SIMILARITY = 0.1
DEV_SIZE = 0.025
TEST_SIZE = 0.025
train_out_path = 'index/moad_mmseqs_10sim_train'
val_out_path = 'index/moad_mmseqs_10sim_val'
test_out_path = 'index/moad_mmseqs_10sim_test'
...
train_proteins_merge = list(set([chain[:10] for chain in train_proteins]))
dev_proteins_merge = list(set([chain[:10] for chain in dev_proteins]))
test_proteins_merge = list(set([chain[:10] for chain in test_proteins]))
